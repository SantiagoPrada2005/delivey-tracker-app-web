...
async function seed() {
    ...
    try {
        ...
        const org1 = await (0, database_1.createOrganization)({
        ...
        const org2 = await (0, database_1.createOrganization)({
        ...
        await (0, database_1.createUserPermissions)({
        ...
        await (0, database_1.createCliente)({
            nombre: 'María',
            apellido: 'González',
        ...
        await (0, database_1.createProducto)({
        ...
        await (0, database_1.createRepartidor)({
            nombre: 'Carlos',
            apellido: 'Martínez',
        ...
        const clientesOrg1 = await (0, database_1.getClientesByOrganization)(org1Id);
        const clientesOrg2 = await (0, database_1.getClientesByOrganization)(org2Id);
        const productosOrg1 = await (0, database_1.getProductosByOrganization)(org1Id);
        const productosOrg2 = await (0, database_1.getProductosByOrganization)(org2Id);
        const repartidoresOrg1 = await (0, database_1.getRepartidoresByOrganization)(org1Id);
        const repartidoresOrg2 = await (0, database_1.getRepartidoresByOrganization)(org2Id);
        ...
        const pedido1 = await (0, database_1.createPedidoCompleto)({
        ...
        const pedido2 = await (0, database_1.createPedidoCompleto)({
        ...
        const pedido3 = await (0, database_1.createPedidoCompleto)({
        ...
        await (0, database_1.createAsignacionPedido)({
